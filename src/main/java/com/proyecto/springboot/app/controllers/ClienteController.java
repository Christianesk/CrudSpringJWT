...
public class ClienteController {
	...
	//API REST en un controlador normal
	@GetMapping(value = "/listar-rest-api")
	@ResponseBody
...
//				logger.info("Hola usuario ".concat(auth.getName()).concat("tu rol es ").concat(grantedAuthority.getAuthority()));
//				return true;
//			}
//		}
//		
